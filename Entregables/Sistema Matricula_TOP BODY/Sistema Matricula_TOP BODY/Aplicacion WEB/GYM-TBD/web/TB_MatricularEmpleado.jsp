                ...
                <table width="765" border="0" align="center">
                  <tr>
                    ...
                    <td width="693"><!-- InstanceBeginEditable name="EditRegion1" -->
                        ...
                        <table class="texto2">
                        <tr>
                        <td><h3>NUEVO EMPLEADO</h3></td>
                        </tr>
                        </table>
                    <br>
                        <form  id="validateForm" class="validateForm"  method="GET" action="<%=request.getContextPath()%>/TB_EmpleadoServlet?op=Registrar">
	...
	messages: {
		...
		validAfterDatepicker: 'Por favor ingrese una fecha despues de la inicial'
            ...
            <table border="0" align="center" class="texto3">
                  ...
                  <tr>
                      <td>Sueldo:</td>
                      <td><input type="text" name="txtSueldo" class="required"></td>
                  </tr>
