...
<html><!-- InstanceBegin template="/Templates/main_adm.dwt" codeOutsideHTMLIsLocked="false" -->
    ...
    <script type="text/javascript" src="js/jquery.ui.datepicker.js"></script>--%>
    	<script>
            function nuevo()
            {
                document.agregar.action="<%=request.getContextPath()%>/TB_ProductoServlet";
                document.agregar.method="GET";
                document.agregar.op.value="6";
                  ...
                  <tr>
                    ...
                    <td width="693"><!-- InstanceBeginEditable name="EditRegion1" -->
                        ...
                        <form name="agregar">
                            ...
                            <table>
                                <tr>
                                    <td><input type="button" value="Guardar" onClick="nuevo()"></td>
                                </tr>
                            </table>
                        </form>
