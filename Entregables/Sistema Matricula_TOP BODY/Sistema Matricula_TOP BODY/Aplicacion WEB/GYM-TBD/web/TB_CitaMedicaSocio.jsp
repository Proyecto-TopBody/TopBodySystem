...
<html><!-- InstanceBegin template="/Templates/main_socio.dwt" codeOutsideHTMLIsLocked="false" --><head>
            ...
            <tr>
                ...
                <table width="765" border="0" align="center">
                  <tr>
                    ...
                    <form id="validateForm" class="validateForm"  method="GET" action="<%=request.getContextPath()%>/TB_CitaMedicaServlet?op=Enviar">
<pre><code class="jsdemo"><script>$('#validateForm').validate({
	...
	messages: {
		...
		validAfterDatepicker: 'Por favor ingrese una fecha despues de la inicial'
                        ...
                        <center>
                    <h3>Solicitud de Cita Medica</h3>
                    <table width="500">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input id="cnombre" name="txtnombre" class="required"></td>
                    </tr>
                    <tr>
                        <td class="texto3">Correo:</td>
                        <td><input id="ccorreo" name="txtcorreo" class="required email"></td>
                    </tr>
                    <tr>
                        <td class="texto3">
                            <p><span class="demoLabel">Fecha:</span></p>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><textarea name="txtcomentario" cols="30" rows="10" class="required" id="ccomment"></textarea></td>
                    </tr>
                </table>
                <table>
                  <tr>
