...
<html><!-- InstanceBegin template="/Templates/main_socio.dwt" codeOutsideHTMLIsLocked="false" -->
    ...
    %>
    <%
    Lista=(ArrayList<TB_AsistenciaBean>)request.getAttribute("LISTADO");
    %>
        ...
        <td align="center">
            ...
            <tr>
                ...
                <table width="765" border="0" align="center">
                  ...
                  <form id="validateForm" class="validateForm"  method="GET" action="<%=request.getContextPath()%>/TB_AsistenciaServlet1?op=Enviar">
	...
	messages: {
		...
		validAfterDatepicker: 'Por favor ingrese una fecha despues de la inicial'
                  ...
                  <center>
                    ...
                    <table width="500">
                    <tr>
                        <td class="texto3">Ingrese su codigo, por favor:</td>
                        <td><input id="ccodigo" name="txtcodigo" class="required"></td>
                    </tr>
                </table>
                <table>
                  <tr>
                        <td><input type="submit" name="op" value="Consultar" id="boton" class="boton"></td>
                        <%
                    ...
                    <%if(Lista!=null)
                    {
                        ...
                        for( TB_AsistenciaBean obj:Lista )
                        {
                     %>
